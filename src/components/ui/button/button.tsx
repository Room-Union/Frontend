  ...
  "cursor-pointer text-center font-semibold transition-all",
  {
    variants: {
      variant: {
        ...
        secondary:
          "bg-white border border-gray-neutral-200 text-gray-neutral-500 hover:bg-gray-neutral-100 active:bg-gray-neutral-200  disabled:cursor-not-allowed",
        outline:
      ...
      size: {
        ...
        sm: "flex typo-ui-sm-semibold py-2.5 px-4 rounded-[10px] max-w-[84px] h-[38px] leading-3.5 place-items-center",
