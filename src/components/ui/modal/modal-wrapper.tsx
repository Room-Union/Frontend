  ...
  return (
    <Dialog.Root open={open} onOpenChange={setOpen}>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="tb:w-[544px] mo:w-[350px] tb:p-10 mo:p-5 tb:rounded-[36px] mo:rounded-[24px] fixed top-1/2 left-1/2 max-h-[95vh] -translate-x-1/2 -translate-y-1/2 overflow-hidden bg-white">
