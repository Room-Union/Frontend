...
const Banner = ({ className }: { className?: string }) => {
  return (
    <div
      className={cn(
        "mo:h-[116.357px] pc:h-[244px] tb:h-[141.52px] pc:pl-15 pc:pr-[29.39px] tb:pl-[34.8px] tb:pr-[40.24px] mo:pl-[19px] mo:pr-[21.86px] flex w-full min-w-[375px] items-center justify-between overflow-hidden rounded-[28px] bg-blue-400",
        className
      )}
    >
      ...
      <BannerIcon className="pc:h-full tb:h-[144.593px] mo:h-[78.5px] w-auto shrink-0 pt-[7.959px]" />
    </div>
  );
};
