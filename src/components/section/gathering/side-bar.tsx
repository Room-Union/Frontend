...
const SideBar = ({ data }: SideBarProps) => {
  return (
    <div className="bg-base-white tb:sticky tb:top-0 tb:w-[380px] tb:rounded-[20px] tb:border tb:border-neutral-100 tb:p-6 mo:px-6 flex h-fit w-full shrink-0 flex-col gap-[10px] border-t border-neutral-200 px-5 py-6">
